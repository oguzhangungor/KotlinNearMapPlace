...
import com.ogungor.kotlinnearmapplace.Helper.DirectionJSONParser
...
class ViewDirectionActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun drawPath(mLastLocation: Location?, location: com.ogungor.kotlinnearmapplace.Model.Location?) {
        if (polyline!=null){
